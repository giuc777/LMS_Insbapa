...
@Component({
  selector: 'app-estudiante-anuncios',
  standalone: true,
  template: `
    <div class="page-head">
      <div class="crumb">Anuncios</div>
      <h2>Anuncios</h2>
      <div class="page-sub">Avisos y notificaciones</div>
    </div>
    <div class="card">
      <p>Modulo en construccion - Fase 7.</p>
    </div>
  `,
  styles: [`
...
export class EstudianteAnunciosComponent {}
