...
@Component({
  selector: 'app-estudiante-examenes',
  standalone: true,
  template: `
    <div class="page-head">
      <div class="crumb">Mis Examenes</div>
      <h2>Mis Examenes</h2>
      <div class="page-sub">Examenes disponibles y realizados</div>
    </div>
    <div class="card">
      <p>Modulo en construccion - Fase 11.</p>
    </div>
  `,
  styles: [`
...
export class EstudianteExamenesComponent {}
