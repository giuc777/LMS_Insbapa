...
@Component({
  ...
  template: `
    <div class="page-head">
      <div class="crumb">Tareas</div>
      <h2>Tareas</h2>
      <div class="page-sub">Crear, gestionar y calificar tareas</div>
    </div>
    <div class="card">
      <p>Modulo en construccion - Fase 10.</p>
    </div>
  `,
  styles: [`
...
export class ProfesorTareasComponent {}
